            ...
            <div className="movie-detials container text-white w-50 d-flex flex-column justify-content-around">
              ...
              <div className="bottom pb-5">
                ...
                <div className="d-flex justify-content-center gap-4 flex-wrap">
                  <p><span className="info-label">Revenue</span> {movie.revenue ? `$${movie.revenue.toLocaleString()}` : "N/A"}</p>
                  <p><span className="info-label">Status</span> {movie.status}</p>
                  <p><span className="info-label">Language</span> {movie.original_language?.toUpperCase()}</p>
                </div>
              </div>
            </div>
          </div>
